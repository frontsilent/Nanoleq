...
<div class="page-body">
            ...
            <div class="blog-top">
                <div class="blog-top__left">
                    ...
                    <div class="blog-top__text text-group text-group--white">
                        <p>
                            Petierunt uti sibi concilium totius Galliae in diem certam indicere. Curabitur blandit tempus ardua ridiculus sed magna. Quae vero auctorem tractata ab fiducia dicuntur. Morbi fringilla convallis sapien
                        </p>
                        <?php $articleText = get_field('post_text', $topArticle); ?>
                        <p><?php echo mb_strimwidth($articleText, 0, 5, "..."); ?></p>
                    </div>
                ...
                <div class="blog-top__image">
                    ...
                    <?php if (!get_field('video', $topArticle)) : ?>
                        <img src="<?php echo get_field('post_img', $topArticle); ?>" alt="blog">
                    <?php else: ?>
                        <video src="<?php echo get_field('video_file', $topArticle); ?>"></video>
    ...
    <!-- blog-dates -->
    <section id="blog-dates" class="section blog-dates-section">
        <div class="container">
